...
Standalone backend datasource plugin for **Grafana 13.0.1 and newer**.
...
- `artifacts/dataspacelab-dil-datasource-0.2.0.zip`
- `artifacts/dataspacelab-dil-datasource-0.2.0.zip.sha256`
- `artifacts/dataspacelab-dil-datasource/`: extracted installable plugin

The ZIP includes the frontend and Go backends for Linux amd64/arm64,
...
The plugin provides QueryData, CheckHealth, a restricted manifest resource
